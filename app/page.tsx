  ...
  return (
    <main>
      ...
      <section className="section mt-20 grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl bg-white p-8 border border-slate-200">
            ...
            <p className="mt-2">
              <a className="text-brand-700 font-semibold" href="tel:+19493753457">
                (949) 375-3457
              </a>
            </p>
            <p className="mt-1">
              <a className="text-brand-700" href="mailto:calprideplumbing@gmail.com">
                calprideplumbing@gmail.com
              </a>
            </p>
      ...
      <section className="section mt-20 mb-24 text-center">
        <a className="btn-primary" href="tel:+19493753457">
          Tap to Call Now
        </a>
      </section>
    </main>
