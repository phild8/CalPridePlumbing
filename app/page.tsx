    ...
    <main>
      ...
      <section className="section mt-14">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ['Leak detection (slab leaks) & repair', <Droplet key="d" className="h-6 w-6" />],
        ...
        <div className="mt-6">
          <a className="btn-secondary" href="/services">See all services</a>
        </div>
      </section>
      ...
      <section className="section mt-20 grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-4">
          <div className="rounded-2xl bg-white p-8 border border-slate-200">
            ...
            <p className="mt-2">
              <a className="text-brand-700 font-semibold" href="tel:+19493753457">(949) 375-3457</a>
            </p>
            <p className="mt-1">
              <a className="text-brand-700" href="mailto:calprideplumbing@gmail.com">calprideplumbing@gmail.com</a>
            </p>
          ...
          <div className="rounded-2xl overflow-hidden border border-slate-200">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d26619.728!2d-117.689!3d33.646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80dcda94c6%3A0x0!2sLake%20Forest%2C%20CA!5e0!3m2!1sen!2sus!4v0000000000"
            ></iframe>
          </div>
        </div>
      </section>
